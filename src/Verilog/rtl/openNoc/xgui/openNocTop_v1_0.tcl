...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "sw_no" -parent ${Page_0}
...
proc update_PARAM_VALUE.sw_no { PARAM_VALUE.sw_no } {
	# Procedure called to update sw_no when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.sw_no { PARAM_VALUE.sw_no } {
	# Procedure called to validate sw_no
	return true
}
...
proc update_MODELPARAM_VALUE.sw_no { MODELPARAM_VALUE.sw_no PARAM_VALUE.sw_no } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.sw_no}] ${MODELPARAM_VALUE.sw_no}
}
