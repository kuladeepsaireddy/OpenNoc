...
HD_PWD='C:/Users/vipin.kizheppatt/OneDrive/Reserch/mygit/OpenNoc/App/Vivado/openNoc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log procTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source procTop.tcl
