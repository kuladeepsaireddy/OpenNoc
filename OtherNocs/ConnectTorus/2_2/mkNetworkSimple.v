...
//
// On Sun Jun 10 12:35:02 EDT 2018
//
...
module mkNetworkSimple(CLK,
  ...
  RegFileLoadSyn #( /*file*/ "torus_4RTs_2VCs_8BD_32DW_SepIFRoundRobinAlloc_2RTsPerRow_2RTsPerCol_routing_1.hex",
		    /*addr_width*/ 32'd2,
		    /*data_width*/ 32'd3,
		    /*lo*/ 32'd0,
		    /*hi*/ 32'd3,
  ...
  RegFileLoadSyn #( /*file*/ "torus_4RTs_2VCs_8BD_32DW_SepIFRoundRobinAlloc_2RTsPerRow_2RTsPerCol_routing_2.hex",
		    /*addr_width*/ 32'd2,
		    /*data_width*/ 32'd3,
		    /*lo*/ 32'd0,
		    /*hi*/ 32'd3,
  ...
  RegFileLoadSyn #( /*file*/ "torus_4RTs_2VCs_8BD_32DW_SepIFRoundRobinAlloc_2RTsPerRow_2RTsPerCol_routing_3.hex",
		    /*addr_width*/ 32'd2,
		    /*data_width*/ 32'd3,
		    /*lo*/ 32'd0,
		    /*hi*/ 32'd3,
  ...
  RegFileLoadSyn #( /*file*/ "torus_4RTs_2VCs_8BD_32DW_SepIFRoundRobinAlloc_2RTsPerRow_2RTsPerCol_routing_0.hex",
		    /*addr_width*/ 32'd2,
		    /*data_width*/ 32'd3,
		    /*lo*/ 32'd0,
		    /*hi*/ 32'd3,
  ...
  assign net_routers_routeTable_1_rt_ifc_banks_banks_rf_1$ADDR_1 =
	     net_routers_router_core$out_ports_1_getFlit[34:33] ;
  ...
  assign net_routers_routeTable_1_rt_ifc_banks_banks_rf_4$ADDR_1 =
	     net_routers_router_core_3$out_ports_4_getFlit[34:33] ;
  ...
  assign net_routers_routeTable_2_rt_ifc_banks_banks_rf_2$ADDR_1 =
	     net_routers_router_core$out_ports_2_getFlit[34:33] ;
  ...
  assign net_routers_routeTable_2_rt_ifc_banks_banks_rf_3$ADDR_1 =
	     net_routers_router_core_3$out_ports_3_getFlit[34:33] ;
  ...
  assign net_routers_routeTable_3_rt_ifc_banks_banks_rf_1$ADDR_1 =
	     net_routers_router_core_2$out_ports_1_getFlit[34:33] ;
  ...
  assign net_routers_routeTable_3_rt_ifc_banks_banks_rf_2$ADDR_1 =
	     net_routers_router_core_1$out_ports_2_getFlit[34:33] ;
  ...
  assign net_routers_routeTable_rt_ifc_banks_banks_rf_3$ADDR_1 =
	     net_routers_router_core_1$out_ports_3_getFlit[34:33] ;
  ...
  assign net_routers_routeTable_rt_ifc_banks_banks_rf_4$ADDR_1 =
	     net_routers_router_core_2$out_ports_4_getFlit[34:33] ;
  ...
  begin
	...
	$write("");
    if (RST_N)
      if (net_routers_router_core$out_ports_1_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core_2$out_ports_1_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core_1$out_ports_1_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core_3$out_ports_1_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core$out_ports_2_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core_2$out_ports_2_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core_1$out_ports_2_getFlit[36]) $write("");
    if (RST_N)
    ...
    if (RST_N)
      if (net_routers_router_core_1$out_ports_3_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core_3$out_ports_3_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core$out_ports_4_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core_2$out_ports_4_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core_1$out_ports_4_getFlit[36]) $write("");
    if (RST_N)
      if (net_routers_router_core_3$out_ports_4_getFlit[36]) $write("");
  end
