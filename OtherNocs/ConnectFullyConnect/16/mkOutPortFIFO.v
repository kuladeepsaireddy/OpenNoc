...
//
// On Sun Jun 10 13:14:21 EDT 2018
//
...
module mkOutPortFIFO(CLK,
  ...
  reg [3 : 0] outPortFIFO_ifc_fifo_mem;
  wire [3 : 0] outPortFIFO_ifc_fifo_mem$D_IN;
  wire outPortFIFO_ifc_fifo_mem$EN;

  // register outPortFIFO_ifc_fifo_mem_1
  reg [3 : 0] outPortFIFO_ifc_fifo_mem_1;
  wire [3 : 0] outPortFIFO_ifc_fifo_mem_1$D_IN;
  wire outPortFIFO_ifc_fifo_mem_1$EN;

  // register outPortFIFO_ifc_fifo_mem_2
  reg [3 : 0] outPortFIFO_ifc_fifo_mem_2;
  wire [3 : 0] outPortFIFO_ifc_fifo_mem_2$D_IN;
  wire outPortFIFO_ifc_fifo_mem_2$EN;

  // register outPortFIFO_ifc_fifo_mem_3
  reg [3 : 0] outPortFIFO_ifc_fifo_mem_3;
  wire [3 : 0] outPortFIFO_ifc_fifo_mem_3$D_IN;
  wire outPortFIFO_ifc_fifo_mem_3$EN;

  // register outPortFIFO_ifc_fifo_mem_4
  reg [3 : 0] outPortFIFO_ifc_fifo_mem_4;
  wire [3 : 0] outPortFIFO_ifc_fifo_mem_4$D_IN;
  wire outPortFIFO_ifc_fifo_mem_4$EN;

  // register outPortFIFO_ifc_fifo_mem_5
  reg [3 : 0] outPortFIFO_ifc_fifo_mem_5;
  wire [3 : 0] outPortFIFO_ifc_fifo_mem_5$D_IN;
  wire outPortFIFO_ifc_fifo_mem_5$EN;

  // register outPortFIFO_ifc_fifo_mem_6
  reg [3 : 0] outPortFIFO_ifc_fifo_mem_6;
  wire [3 : 0] outPortFIFO_ifc_fifo_mem_6$D_IN;
  wire outPortFIFO_ifc_fifo_mem_6$EN;

  // register outPortFIFO_ifc_fifo_mem_7
  reg [3 : 0] outPortFIFO_ifc_fifo_mem_7;
  wire [3 : 0] outPortFIFO_ifc_fifo_mem_7$D_IN;
  ...
  begin
	...
	outPortFIFO_ifc_fifo_mem <= `BSV_ASSIGNMENT_DELAY 4'd0;
	outPortFIFO_ifc_fifo_mem_1 <= `BSV_ASSIGNMENT_DELAY 4'd0;
	outPortFIFO_ifc_fifo_mem_2 <= `BSV_ASSIGNMENT_DELAY 4'd0;
	outPortFIFO_ifc_fifo_mem_3 <= `BSV_ASSIGNMENT_DELAY 4'd0;
	outPortFIFO_ifc_fifo_mem_4 <= `BSV_ASSIGNMENT_DELAY 4'd0;
	outPortFIFO_ifc_fifo_mem_5 <= `BSV_ASSIGNMENT_DELAY 4'd0;
	outPortFIFO_ifc_fifo_mem_6 <= `BSV_ASSIGNMENT_DELAY 4'd0;
	outPortFIFO_ifc_fifo_mem_7 <= `BSV_ASSIGNMENT_DELAY 4'd0;
  ...
  begin
    ...
    outPortFIFO_ifc_fifo_mem = 4'hA;
    outPortFIFO_ifc_fifo_mem_1 = 4'hA;
    outPortFIFO_ifc_fifo_mem_2 = 4'hA;
    outPortFIFO_ifc_fifo_mem_3 = 4'hA;
    outPortFIFO_ifc_fifo_mem_4 = 4'hA;
    outPortFIFO_ifc_fifo_mem_5 = 4'hA;
    outPortFIFO_ifc_fifo_mem_6 = 4'hA;
    outPortFIFO_ifc_fifo_mem_7 = 4'hA;
