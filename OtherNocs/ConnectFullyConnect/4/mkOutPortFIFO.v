...
//
// On Sun Jun 10 13:12:35 EDT 2018
//
...
module mkOutPortFIFO(CLK,
  ...
  reg [1 : 0] outPortFIFO_ifc_fifo_mem;
  wire [1 : 0] outPortFIFO_ifc_fifo_mem$D_IN;
  ...
  reg [1 : 0] outPortFIFO_ifc_fifo_mem_4;
  wire [1 : 0] outPortFIFO_ifc_fifo_mem_4$D_IN;
  wire outPortFIFO_ifc_fifo_mem_4$EN;

  // register outPortFIFO_ifc_fifo_mem_5
  reg [1 : 0] outPortFIFO_ifc_fifo_mem_5;
  wire [1 : 0] outPortFIFO_ifc_fifo_mem_5$D_IN;
  wire outPortFIFO_ifc_fifo_mem_5$EN;

  // register outPortFIFO_ifc_fifo_mem_6
  reg [1 : 0] outPortFIFO_ifc_fifo_mem_6;
  wire [1 : 0] outPortFIFO_ifc_fifo_mem_6$D_IN;
  wire outPortFIFO_ifc_fifo_mem_6$EN;

  // register outPortFIFO_ifc_fifo_mem_7
  reg [1 : 0] outPortFIFO_ifc_fifo_mem_7;
  wire [1 : 0] outPortFIFO_ifc_fifo_mem_7$D_IN;
  ...
  begin
	...
	outPortFIFO_ifc_fifo_mem <= `BSV_ASSIGNMENT_DELAY 2'd0;
	...
	outPortFIFO_ifc_fifo_mem_4 <= `BSV_ASSIGNMENT_DELAY 2'd0;
	outPortFIFO_ifc_fifo_mem_5 <= `BSV_ASSIGNMENT_DELAY 2'd0;
	outPortFIFO_ifc_fifo_mem_6 <= `BSV_ASSIGNMENT_DELAY 2'd0;
	outPortFIFO_ifc_fifo_mem_7 <= `BSV_ASSIGNMENT_DELAY 2'd0;
  ...
  begin
    ...
    outPortFIFO_ifc_fifo_mem = 2'h2;
    outPortFIFO_ifc_fifo_mem_1 = 2'h2;
    outPortFIFO_ifc_fifo_mem_2 = 2'h2;
    outPortFIFO_ifc_fifo_mem_3 = 2'h2;
    outPortFIFO_ifc_fifo_mem_4 = 2'h2;
    outPortFIFO_ifc_fifo_mem_5 = 2'h2;
    outPortFIFO_ifc_fifo_mem_6 = 2'h2;
    outPortFIFO_ifc_fifo_mem_7 = 2'h2;
