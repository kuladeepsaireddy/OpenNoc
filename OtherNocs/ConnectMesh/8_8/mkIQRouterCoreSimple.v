...
//
// On Sun Jun 10 13:02:21 EDT 2018
//
...
// out_ports_0_getFlit            O    41
// out_ports_1_getFlit            O    41
// out_ports_2_getFlit            O    41
// out_ports_3_getFlit            O    41
// out_ports_4_getFlit            O    41
// CLK                            I     1 clock
// RST_N                          I     1 reset
// in_ports_0_putRoutedFlit_flit_in  I    44
// in_ports_1_putRoutedFlit_flit_in  I    44
// in_ports_2_putRoutedFlit_flit_in  I    44
// in_ports_3_putRoutedFlit_flit_in  I    44
// in_ports_4_putRoutedFlit_flit_in  I    44
...
module mkIQRouterCoreSimple(CLK,
  ...
  input  [43 : 0] in_ports_0_putRoutedFlit_flit_in;
  ...
  input  [43 : 0] in_ports_1_putRoutedFlit_flit_in;
  ...
  input  [43 : 0] in_ports_2_putRoutedFlit_flit_in;
  ...
  input  [43 : 0] in_ports_3_putRoutedFlit_flit_in;
  ...
  input  [43 : 0] in_ports_4_putRoutedFlit_flit_in;
  ...
  output [40 : 0] out_ports_0_getFlit;
  ...
  output [40 : 0] out_ports_1_getFlit;
  ...
  output [40 : 0] out_ports_2_getFlit;
  ...
  output [40 : 0] out_ports_3_getFlit;
  ...
  output [40 : 0] out_ports_4_getFlit;
  ...
  // inlined wires
  wire [40 : 0] hasFlitsToSend_perIn$wget,
  ...
  wire [39 : 0] flitBuffers$deq, flitBuffers$enq_data_in;
  ...
  wire [39 : 0] flitBuffers_1$deq, flitBuffers_1$enq_data_in;
  ...
  wire [39 : 0] flitBuffers_2$deq, flitBuffers_2$enq_data_in;
  ...
  wire [39 : 0] flitBuffers_3$deq, flitBuffers_3$enq_data_in;
  ...
  wire [39 : 0] flitBuffers_4$deq, flitBuffers_4$enq_data_in;
  ...
  reg [39 : 0] IF_IF_outport_encoder_45_BIT_3_46_THEN_IF_outp_ETC___d845,
  ...
  wire [39 : 0] IF_IF_outport_encoder_45_BIT_3_46_THEN_NOT_out_ETC___d390,
  ...
  // submodule flitBuffers
  assign flitBuffers$enq_data_in = in_ports_0_putRoutedFlit_flit_in[42:3] ;
  assign flitBuffers$EN_enq =
	     EN_in_ports_0_putRoutedFlit &&
	     in_ports_0_putRoutedFlit_flit_in[43] ;
  assign flitBuffers$EN_deq = outport_encoder___d832[3] ;

  // submodule flitBuffers_1
  assign flitBuffers_1$enq_data_in = in_ports_1_putRoutedFlit_flit_in[42:3] ;
  assign flitBuffers_1$EN_enq =
	     EN_in_ports_1_putRoutedFlit &&
	     in_ports_1_putRoutedFlit_flit_in[43] ;
  assign flitBuffers_1$EN_deq = outport_encoder___d831[3] ;

  // submodule flitBuffers_2
  assign flitBuffers_2$enq_data_in = in_ports_2_putRoutedFlit_flit_in[42:3] ;
  assign flitBuffers_2$EN_enq =
	     EN_in_ports_2_putRoutedFlit &&
	     in_ports_2_putRoutedFlit_flit_in[43] ;
  assign flitBuffers_2$EN_deq = outport_encoder___d830[3] ;

  // submodule flitBuffers_3
  assign flitBuffers_3$enq_data_in = in_ports_3_putRoutedFlit_flit_in[42:3] ;
  assign flitBuffers_3$EN_enq =
	     EN_in_ports_3_putRoutedFlit &&
	     in_ports_3_putRoutedFlit_flit_in[43] ;
  assign flitBuffers_3$EN_deq = outport_encoder___d829[3] ;

  // submodule flitBuffers_4
  assign flitBuffers_4$enq_data_in = in_ports_4_putRoutedFlit_flit_in[42:3] ;
  assign flitBuffers_4$EN_enq =
	     EN_in_ports_4_putRoutedFlit &&
	     in_ports_4_putRoutedFlit_flit_in[43] ;
